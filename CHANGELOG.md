...
* **core:** correct shell command handling and PATH resolution in child-process spawn (tinyexec) ([#1411](https://github.com/lerna-lite/lerna-lite/issues/1411)) ([a6c7a82](https://github.com/lerna-lite/lerna-lite/commit/a6c7a82c81e0c862713fe737ba3b2db431f20e62)) - by @ghiscoding
...
* **deps:** update inquirer packages ([#1408](https://github.com/lerna-lite/lerna-lite/issues/1408)) ([778c5bb](https://github.com/lerna-lite/lerna-lite/commit/778c5bbd9b3bf7ecb0702cf026918bc04920f3e7)) - by @renovate[bot]
...
* **deps:** update all non-major dependencies ([#1369](https://github.com/lerna-lite/lerna-lite/issues/1369)) ([abc5802](https://github.com/lerna-lite/lerna-lite/commit/abc5802fcaea3952f10a88eb800c227380d3f481)) - by @renovate[bot]

## [5.4.1](https://github.com/lerna-lite/lerna-lite/compare/v5.4.0...v5.4.1) (2026-07-13)

### Bug Fixes

* **deps:** update conventional-changelog packages ([#1361](https://github.com/lerna-lite/lerna-lite/issues/1361)) ([59c3f63](https://github.com/lerna-lite/lerna-lite/commit/59c3f63ba0daeac648f9d43155085a190b03ccf1)) - by @renovate[bot]
* **deps:** update conventional-changelog packages ([#1366](https://github.com/lerna-lite/lerna-lite/issues/1366)) ([fd47eae](https://github.com/lerna-lite/lerna-lite/commit/fd47eae2855ec01246d9355d2256959e7bc4d20c)) - by @renovate[bot]
* **version:** honor 0.x major-to-minor in prerelease bumps ([#1358](https://github.com/lerna-lite/lerna-lite/issues/1358)) ([3f44f59](https://github.com/lerna-lite/lerna-lite/commit/3f44f5911393588e96d5a33e0bdfdbcd2fbe3cc5)) - by @ghiscoding

## [5.4.0](https://github.com/lerna-lite/lerna-lite/compare/v5.3.0...v5.4.0) (2026-07-02)

### Features

* **deps:** support conventional-changelog new major versions w/fallback ([#1353](https://github.com/lerna-lite/lerna-lite/issues/1353)) ([cd6a6d0](https://github.com/lerna-lite/lerna-lite/commit/cd6a6d072bfb92404b17d223b8ef178428b03d10)) - by @ghiscoding

### Bug Fixes

* **deps:** update all non-major dependencies ([#1354](https://github.com/lerna-lite/lerna-lite/issues/1354)) ([377e516](https://github.com/lerna-lite/lerna-lite/commit/377e516fa3d1ec71a0620c6e76b6362ca82ef89d)) - by @renovate[bot]

## [5.3.0](https://github.com/lerna-lite/lerna-lite/compare/v5.2.2...v5.3.0) (2026-06-04)

### Features

* **deps:** drop `new-github-release-url` replace with internal code ([#1342](https://github.com/lerna-lite/lerna-lite/issues/1342)) ([5fa8779](https://github.com/lerna-lite/lerna-lite/commit/5fa87799ffc0cbf99a417ba2d1420df2c57d62f7)) - by @ghiscoding
...
* **core:** add missing fs-utils optional arguments ([#1335](https://github.com/lerna-lite/lerna-lite/issues/1335)) ([4dab97d](https://github.com/lerna-lite/lerna-lite/commit/4dab97de5b1e72e194dd304a801150976c77b587)) - by @ghiscoding
...
* **deps:** update inquirer packages ([#1339](https://github.com/lerna-lite/lerna-lite/issues/1339)) ([bee077e](https://github.com/lerna-lite/lerna-lite/commit/bee077e5d524b9ed16db8d9de3a183a9c95529f6)) - by @renovate[bot]
...
* **deps:** update inquirer packages ([#1329](https://github.com/lerna-lite/lerna-lite/issues/1329)) ([f5e9829](https://github.com/lerna-lite/lerna-lite/commit/f5e9829e34651862793f926e9a56b12982af83b5)) - by @renovate[bot]
...
* **core:** replace deprecated url.parse with WHATWG URL API ([#1315](https://github.com/lerna-lite/lerna-lite/issues/1315)) ([4b76cd9](https://github.com/lerna-lite/lerna-lite/commit/4b76cd90e1f3023eece49f240f843fb95ac8d582)) - by @ghiscoding
...
* **deps:** update all non-major dependencies ([#1274](https://github.com/lerna-lite/lerna-lite/issues/1274)) ([9351be2](https://github.com/lerna-lite/lerna-lite/commit/9351be2b47e26addf90dd42e2cd52603b42f6ece)) - by @renovate[bot]
* **deps:** update dependency tar to v7.5.11 [security] ([#1273](https://github.com/lerna-lite/lerna-lite/issues/1273)) ([6ac77a9](https://github.com/lerna-lite/lerna-lite/commit/6ac77a957a39d1c330c0bc9380b0299f312c0b5e)) - by @ghiscoding
...
* add missing Comment issues/PRs count in --dry-run mode ([#1261](https://github.com/lerna-lite/lerna-lite/issues/1261)) ([5226ad1](https://github.com/lerna-lite/lerna-lite/commit/5226ad14eb4cb59e09aeb4967f97020bfab0f159)) - by @ghiscoding
...
* **deps:** update all non-major dependencies ([#1248](https://github.com/lerna-lite/lerna-lite/issues/1248)) ([541fe07](https://github.com/lerna-lite/lerna-lite/commit/541fe07b583513ca55bd1a98beda21fe91d80a03)) - by @renovate[bot]
* **deps:** update dependency tar to v7.5.3 [security] ([#1246](https://github.com/lerna-lite/lerna-lite/issues/1246)) ([698614c](https://github.com/lerna-lite/lerna-lite/commit/698614c675def94051feaa3c6665b29e5010405f)) - by @renovate[bot]
* should comment on all linked issues/PRs ([#1245](https://github.com/lerna-lite/lerna-lite/issues/1245)) ([39e0f55](https://github.com/lerna-lite/lerna-lite/commit/39e0f55c6d71d3a9aa4265bb0096349a3f225114)) - by @ghiscoding
...
* use args to run git show command ([#1216](https://github.com/lerna-lite/lerna-lite/issues/1216)) ([9c255e5](https://github.com/lerna-lite/lerna-lite/commit/9c255e5ac1903c2234886487b72793593c49b8ad)) - by @ghoullier
* Version/Publish --yes log should show only after all Changes logged ([#1214](https://github.com/lerna-lite/lerna-lite/issues/1214)) ([cd1e474](https://github.com/lerna-lite/lerna-lite/commit/cd1e47462c16f2cec74d7aef9fce470dc54a3b51)) - by @ghiscoding
* **version:** `whatBump` must be a function, fixes [#1217](https://github.com/lerna-lite/lerna-lite/issues/1217) ([#1219](https://github.com/lerna-lite/lerna-lite/issues/1219)) ([c87336c](https://github.com/lerna-lite/lerna-lite/commit/c87336c512a74f5f3f8f96a5d0cc7397f1e936b9)) - by @ghiscoding
* **version:** avoid duplicate issue/PR comments ([#1222](https://github.com/lerna-lite/lerna-lite/issues/1222)) ([4835ba9](https://github.com/lerna-lite/lerna-lite/commit/4835ba94d287a0e465ee74bcf6b2b5acc4a5d75a)) - by @ghiscoding

## [4.10.2](https://github.com/lerna-lite/lerna-lite/compare/v4.10.1...v4.10.2) (2025-12-13)

### Bug Fixes

* **version:** use new version tag in issue comment & add rate limiter ([#1210](https://github.com/lerna-lite/lerna-lite/issues/1210)) ([c2ba04e](https://github.com/lerna-lite/lerna-lite/commit/c2ba04ee8b7676b0f06007c1d32ac5c96f3f08a4)) - by @ghiscoding
...
* **deps:** update all non-major dependencies ([#1184](https://github.com/lerna-lite/lerna-lite/issues/1184)) ([ed17bf7](https://github.com/lerna-lite/lerna-lite/commit/ed17bf7d1e1ebe8af53b321b83ac774e20454d96)) - by @renovate[bot]
* **deps:** update all non-major dependencies ([#1188](https://github.com/lerna-lite/lerna-lite/issues/1188)) ([aea4b22](https://github.com/lerna-lite/lerna-lite/commit/aea4b22f4b13ad5bddc2b87e335f707084f7011e)) - by @renovate[bot]
* **deps:** update inquirer packages ([#1187](https://github.com/lerna-lite/lerna-lite/issues/1187)) ([45fccea](https://github.com/lerna-lite/lerna-lite/commit/45fccea8a2610bf351668a20ce05feee3efce783)) - by @renovate[bot]
...
* **deps:** update all non-major dependencies ([#1124](https://github.com/lerna-lite/lerna-lite/issues/1124)) ([827e1df](https://github.com/lerna-lite/lerna-lite/commit/827e1dfeca84985d80bcafa44c21e1e03ce37884)) - by @renovate[bot]
* **deps:** update dependency @npmcli/package-json to v7 ([#1121](https://github.com/lerna-lite/lerna-lite/issues/1121)) ([8520bf9](https://github.com/lerna-lite/lerna-lite/commit/8520bf9a71dc8e4f2a240c68954610f843851931)) - by @renovate[bot]
...
* **deps:** update dependency p-limit to v7 ([#1114](https://github.com/lerna-lite/lerna-lite/issues/1114)) ([d49dee9](https://github.com/lerna-lite/lerna-lite/commit/d49dee94be71bf654e3c67796ff9b0a8c10ff1ae)) - by @renovate[bot]
...
* **deps:** update conventional-changelog packages ([#1087](https://github.com/lerna-lite/lerna-lite/issues/1087)) ([bbf5045](https://github.com/lerna-lite/lerna-lite/commit/bbf504576085150eb374911bee7afcaa6ab66619)) - by @renovate[bot]
