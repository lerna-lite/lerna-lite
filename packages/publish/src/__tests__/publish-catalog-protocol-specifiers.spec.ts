...
vi.mock(
  ...
  async () => await vi.importActual<any>('../../../version/src/lib/__mocks__/is-behind-upstream')
);
vi.mock(
  '../../../version/src/lib/remote-branch-exists',
  async () => await vi.importActual<any>('../../../version/src/lib/__mocks__/remote-branch-exists')
);
