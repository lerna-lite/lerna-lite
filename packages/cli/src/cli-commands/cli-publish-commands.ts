...
const versionCommandOptions = require('./cli-version-commands');
...
function composeVersionOptions(yargs) {
  versionCommandOptions.addBumpPositional(yargs, ['from-git', 'from-package']);
  versionCommandOptions.builder(yargs, 'publish');
