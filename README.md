...
Lerna-Lite itself is also using [pnpm catalogs](https://pnpm.io/catalogs) and [pnpm workspaces](https://pnpm.io/workspaces) with both of the `catalog:` and `workspace:` protocols 🎉
...
5. Lerna-Lite added a few unique features (not available in Lerna itself):
   ...
   - [`catalog:` protocol support](https://github.com/lerna-lite/lerna-lite/tree/main/packages/version#catalog-protocol) for `version` and `publish` commands
