...
- Automate the rolling of new Versions (independent or fixed) for all your packages
  - it will automatically add Commit & Tag your new version in Git and even create a new release in GitHub if you want it to
