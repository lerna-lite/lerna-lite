...
Click on any command to see all available options
...
> **Note** all commands are optional in Lerna-Lite, refer to the [Installation table](#available-commands) for more info
