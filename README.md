...
- Commands
  - included with CLI
    ...
    - 💻 [`info`](https://github.com/lerna-lite/lerna-lite/tree/main/packages/info#readme) - print local environment information (useful when opening new issue)
...
Watch for file changes within packages and execute commands from the root of the repository. This solves a common problem for package-based monorepos, which is to trigger rebuilds of packages when their files change (ie: TypeScript, SASS, ...). Head over to the [`lerna watch`](https://github.com/lerna-lite/lerna-lite/tree/main/packages/watch#readme) documentation for more details.
...
| 💻 [info](https://github.com/lerna-lite/lerna-lite/tree/main/packages/info#readme) | print local environment information |
...
| [@lerna-lite/info](https://github.com/lerna-lite/lerna-lite/tree/main/packages/info) | [![npm](https://img.shields.io/npm/v/@lerna-lite/info.svg)](https://www.npmjs.com/package/@lerna-lite/info) | Print local environment information | [changelog](https://github.com/lerna-lite/lerna-lite/blob/main/packages/info/CHANGELOG.md) |
...
| [@lerna-lite/optional-cmd-common](https://github.com/lerna-lite/lerna-lite/tree/main/packages/optional-cmd-common) | [![npm](https://img.shields.io/npm/v/@lerna-lite/optional-cmd-common.svg)](https://www.npmjs.com/package/@lerna-lite/optional-cmd-common) | Lerna-Lite common utils for optional commands Exec/List/Run (internal use) | [changelog](https://github.com/lerna-lite/lerna-lite/blob/main/packages/optional-cmd-common/CHANGELOG.md) |
