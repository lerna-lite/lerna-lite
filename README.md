...
| [@lerna-lite/optional-cmd-common](https://github.com/lerna-lite/lerna-lite/tree/main/packages/optional-cmd-common) | [![npm](https://img.shields.io/npm/v/@lerna-lite/optional-cmd-common.svg)](https://www.npmjs.com/package/@lerna-lite/optional-cmd-common) | Lerna-Lite common utils for optional commands Exec/List/Run/Watch (internal use) | [changelog](https://github.com/lerna-lite/lerna-lite/blob/main/packages/optional-cmd-common/CHANGELOG.md) |
